...
Documenten om na te lezen of mee te nemen, allemaal in de huisstijl en met het logo.
...
| `cashmettrash-toegang-onderbouwing.pdf` | Toegang Tilburg | Vier A4'tjes: wat Jayce feitelijk doet, wat hij ermee leert, hoe het veilig is ingericht, en wat wij vragen |
| `cashmettrash-toegang-leerplan.pdf` | Toegang Tilburg | Bijlage B: leerdoelen per leergebied met bewijs, het weekritme, een logboek en evaluatiemomenten. Bevat velden om ter plekke in te vullen |
