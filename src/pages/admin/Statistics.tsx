...
const AdminStatistics: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setUsers(usersSnap.docs.map(doc => ({ uid: doc.id, ...doc.data() } as UserType)));
  ...
  const approvedUsers = users.filter(u => u.verification_status === 'approved').length;
  ...
  return (
    <div className="flex h-screen" style={{ background: 'var(--vl-bg-primary)' }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:pl-64">
        <Header
          title="Statistieken"
          subtitle="Volledig overzicht van alle platform statistieken en analyses"
          icon={BarChart3}
        />
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="vl-card p-6">
                      ...
                      <p className="text-3xl font-black text-white mb-1">{totalUsers}</p>
                      <p className="text-sm text-neutral-500">Totaal gebruikers</p>
                    </div>
                    ...
                    <div className="vl-card p-6">
                      ...
                      <p className="text-3xl font-black text-white mb-1">{approvedUsers}</p>
                      <p className="text-sm text-neutral-500">Goedgekeurd</p>
                    </div>
                    ...
                    <div className="vl-card p-6">
                      ...
                      <p className="text-3xl font-black text-white mb-1">{pendingUsers}</p>
