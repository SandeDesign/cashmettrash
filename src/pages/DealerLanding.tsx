...
import { ShoppingCart, Car, TrendingUp, Shield, CheckCircle, ArrowRight, Clock, Euro, BarChart3, Zap, Package, Calendar } from 'lucide-react';
import PublicHeader from '../components/layout/PublicHeader';

const DealerLanding: React.FC = () => {
    ...
    <div className="min-h-screen bg-neutral-950 text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 40%, #16213e 70%, #0a0a0a 100%)' }}>
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1562141961-4a883a3c7e15?w=1920&q=80"
            alt="Autohandel showroom"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-green-400">Voor Autohandelaren</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              Verhuur je <span className="text-green-400">voorraad</span><br />
              en verdien extra
            </h1>

            <p className="text-xl md:text-2xl text-neutral-300 mb-8 leading-relaxed">
              Maak optimaal gebruik van je voorraadauto's door ze te verhuren via VLOTTR.
              Genereer inkomsten terwijl je auto's op een koper wachten.
            </p>
      ...
      <section id="voordelen" className="py-24 bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-400">Optimaliseer je voorraad rendement</p>
          </div>
            ...
            {[
              {
                ...
                description: 'Verdien aan auto\'s die anders stilstaan in je showroom'
              },
              {
                icon: Car,
                title: 'Voorraad Optimalisatie',
                description: 'Houd auto\'s in beweging en verkoop sneller'
              },
              {
                icon: TrendingUp,
                title: 'Meer Exposure',
                description: 'Potentiële kopers leren je auto\'s kennen tijdens verhuur'
              },
              {
                icon: Shield,
                title: 'Volledig Verzekerd',
                description: 'Wij verzorgen verzekering en schadeafhandeling'
              },
              {
                icon: Clock,
                title: 'Flexibel Beheer',
                description: 'Bepaal zelf welke auto\'s beschikbaar zijn'
              },
              {
                icon: BarChart3,
                title: 'Real-time Inzicht',
                description: 'Dashboard met boekingen en omzet overzicht'
              }
            ].map((benefit, index) => (
              <div
                key={index}
      ...
      <section className="py-24 bg-neutral-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-400">In 4 stappen aan de slag</p>
          </div>
            ...
            {[
              {
                ...
                icon: Package,
                title: 'Aanmelden',
                description: 'Registreer als dealer partner'
              },
              {
                step: '2',
                icon: CheckCircle,
                title: 'Verificatie',
                description: 'Bedrijfsgegevens worden geverifieerd'
              },
              {
                step: '3',
                icon: Car,
                title: 'Auto\'s Toevoegen',
                description: 'Upload je verhuurbare voorraad'
              },
              {
                step: '4',
                icon: Zap,
                title: 'Verdienen',
                description: 'Ontvang automatisch je verdiensten'
              }
            ].map((step, index) => (
      ...
      <section className="py-24 bg-gradient-to-br from-green-900 to-green-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6">Klaar om te starten?</h2>
          <p className="text-xl text-neutral-200 mb-8">
            Sluit je aan bij VLOTTR en optimaliseer je voorraadrendement
          </p>
          <Link
            to="/registreren"
