// src/components/contant/ContantBeheer.tsx
//
// Het contante geld: wat Jayce heeft meegekregen en of dat thuis is aangekomen.
//
// Mama en de beheerder zien hier dezelfde lijst, alleen met hun eigen menu
// eromheen. Een klant kan namelijk bij allebei de stromen kiezen om niet in de
// app te betalen maar het geld mee te geven aan Jayce: de ophaalbeurt voor glas,
// en de ophaalkosten bij statiegeld. Dan moet iemand wel zien dat het geld er
// echt is. Jayce doet dat niet zelf: hij is tien en heeft geen bedragen op zijn
// pagina's.
//
// Zolang er niets is afgevinkt geldt het geld als niet ontvangen. Bij statiegeld
// blijft de Tikkie van de klant dan op slot.
//
// Het statiegeld zelf staat hier los van. Dat komt uit de automaat van Viatim en
// gaat volledig naar de klant.
