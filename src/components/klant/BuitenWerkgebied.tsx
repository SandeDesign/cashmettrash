...
const BuitenWerkgebied: React.FC<BuitenWerkgebiedProps> = ({ postcode, plaats }) => (
  <div className="cmt-card cmt-animate-in text-center">
    ...
    <p className="text-sm mb-5" style={{ color: 'var(--cmt-ink-soft)' }}>
      ...
      &nbsp;ligt daar net buiten, dus we kunnen hier voorlopig niet komen. Klopt je adres niet?
      Pas het dan aan bij je gegevens.
    </p>
